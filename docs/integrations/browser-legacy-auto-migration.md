...
- **Status:** feature repair tested; independent review pending
...
- **Previous immutable recovery checkpoint:** `0f1990f` (pre-repair); current repair commit is the feature tip, verify with `git rev-parse HEAD`.
- **Feature implementation commit(s):** `83433f3`, `0b77bd5`, `d1de5c2`; stopped pre-domain path repair at current feature tip.
...
- **Remaining gate:** Parent independent review and Hoster read-only preflight of exact manager/lease/path data before any activation. Local disposable tests cannot establish actual Hoster unit/root/CDP state or last-release health. This repair does not mutate Hoster, merge, or push.
...
- **Previous immutable recovery checkpoint:** `0f1990f` (before this repair); review current feature tip for the committed repair.
- **Feature implementation commit(s):** `83433f3`, `0b77bd5`, `d1de5c2`, current feature tip (pre-domain repair).
