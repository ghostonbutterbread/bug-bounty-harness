...
PUBLISHED_STALE_RECLAIM_CORE_SHA = "fc361eca86f9c86acb357e1b9ce6426bc44aef83"
OLD_CORE_SHA = "04b5149f617dafe7837726faec4d1bc5cf5471b6"


class RuntimeDependencyTests(unittest.TestCase):
    def test_checkout_runtime_manifest_pins_published_stale_reclaim_core_revision(self) -> None:
        requirements = (ROOT / "requirements-bounty-core.txt").read_text(encoding="utf-8")
        self.assertRegex(
            requirements,
            rf"(?m)^bounty-core\s*@\s*git\+https://github\.com/ghostonbutterbread/bounty-core\.git@{PUBLISHED_STALE_RECLAIM_CORE_SHA}$",
        )
