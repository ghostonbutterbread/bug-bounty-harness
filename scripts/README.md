...
- **Example:** `python3 scripts/program_init.py example --platform bugcrowd --lane web --lane apk`
- **Preview:** `python3 scripts/program_init.py example --skip-scope --dry-run --json`
