    ...
    *,
    ...
    context_parts.extend(
        [
            ...
            "  **Class:** [vuln class]",
            "  **Severity:** [severity]",
            "  **Scoring Authority:** [program rule / platform rubric / CVSS]",
            "  **Severity Rationale:** [one evidence-based line naming demonstrated impact]",
            "  **Program Constraint:** [scope rule or cap, or omit]",
            "  **File:** [file:line]",
            "  ## Description",
            "  [what you found]",
    ...
    def parse_text(
        ...
        *,
        ...
        finding = {
            ...
            "scoring_authority": _normalize_text(parsed.get("scoring_authority")),
            "severity_rationale": _normalize_text(parsed.get("severity_rationale")),
            "program_constraint": _normalize_text(parsed.get("program_constraint")),
            "cvss_vector": "",
            "cvss_score": "",
