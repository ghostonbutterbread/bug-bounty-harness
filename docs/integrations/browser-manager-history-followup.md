...
- **Status:** review-ready; live DB apply gated
- **Owner:** Hermes bugfix
...
- **Feature implementation commit(s):** `715f07c7ccf58ffaf1c8d037c4e019c355cc353c` (already beta), follow-up pending
...
- Tests: `python3 -m pytest agents/test_browser_manager_row_repair.py -q` → 20 passed; full suite and independent narrow review pending.
...
- **Owning feature branch/ref:** `fix/browser-manager-history-cleanup`
- **Latest immutable recovery checkpoint:** `8d064763bde2183312af04452b141aff42441dc2`
- **Feature implementation commit(s):** `715f07c7ccf58ffaf1c8d037c4e019c355cc353c`; follow-up pending
- **Exact resume point:** run full tests, commit, independent review; then activation.
- **Working-tree state at handoff:** intentionally uncommitted pending tests.
