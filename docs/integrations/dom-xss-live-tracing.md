...
- **Latest immutable recovery checkpoint:** none yet
- **Feature implementation commit(s):** none yet
- **Exact resume point:** verify guidance against XSS router; review, commit, integrate into beta, and verify active skill projection.
- **Working-tree state at handoff:** intentionally uncommitted feature edit and dossier until verification.
